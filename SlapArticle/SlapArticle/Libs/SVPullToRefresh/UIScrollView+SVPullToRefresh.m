...
- (SVPullToRefreshArrow *)arrow {
    if(!_arrow) {
		_arrow = [[SVPullToRefreshArrow alloc]initWithFrame:CGRectMake(0, self.bounds.size.height-54/2, 22/2, 48/2)];
...
- (void)drawRect:(CGRect)rect {
	...
	CGContextAddRect(c, CGRectMake(5/2, 0, 12/2, 4/2)); // to-do: use dynamic points
	CGContextAddRect(c, CGRectMake(5/2, 6/2, 12/2, 4/2)); // currently fixed size: 22 x 48pt
	CGContextAddRect(c, CGRectMake(5/2, 12/2, 12/2, 4/2));
	CGContextAddRect(c, CGRectMake(5/2, 18/2, 12/2, 4/2));
	CGContextAddRect(c, CGRectMake(5/2, 24/2, 12/2, 4/2));
	CGContextAddRect(c, CGRectMake(5/2, 30/2, 12/2, 4/2));
	
	// the arrow
	CGContextMoveToPoint(c, 0, 34/2);
	CGContextAddLineToPoint(c, 11/2, 48/2);
	CGContextAddLineToPoint(c, 22/2, 34/2);
	CGContextAddLineToPoint(c, 0, 34/2);

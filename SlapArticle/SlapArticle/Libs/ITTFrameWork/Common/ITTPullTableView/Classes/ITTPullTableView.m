...
{
    [self showMessage:msg offset:40];
}

- (void)showMessage:(NSString *)msg offset:(float)offset
{
    [self hideMessage];
    
    UIImageView *imgView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"yk_feidie"]];
    imgView.frame = CGRectMake(0, 0, 172, 172);
    imgView.top = offset;
    imgView.centerX = self.width/2;
    imgView.tag = 111;
    [self addSubview:imgView];
    
    UIImageView *imgView1 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"yk_wenan"]];
    imgView1.frame = CGRectMake(0, 0, 250, 97);
    imgView1.centerX = self.width / 2;
    imgView1.top = imgView.bottom + 10;
    imgView1.tag = 112;
    [self addSubview:imgView1];
    
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(88, 20, 65, 21)];
    label.text = @"抱歉！";
    ...
    UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(30, 44, 190, 21)];
    label2.text = msg;
    ...
    [imgView1 addSubview:label2];
}

- (void)hideMessage
{

    UIImageView *imgView1 = (UIImageView *)[self viewWithTag:111];
    UIImageView *imgView2 = (UIImageView *)[self viewWithTag:112];
